...
export const DUMMY_TOPNEWS = new Topnews(
    JSON.parse(
        JSON.stringify({
            status: 'ok',
            totalResults: 38,
            articles: [
                ...
                },
                {
                    ...
                    description:
                        "Bioware is updating players on where the 'Anthem' redesign is, and what's next for the troubled AAA game.",
                ...
                },
                {
                    ...
                    description:
                        'The celebrity chef came up with the recipe while digging up bamboo shoots in Animal Crossing: New Horizons',
