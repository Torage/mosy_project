...
export const DUMMY_TOPNEWS = new Topnews({
    ...
    articles: [
        ...
        },
        {
            ...
            description: 'Coronavirus struck final blow to already struggling department store, reportedly largest retail casualty so far',
...
export const DUMMY_TOPNEWS_2 = new Topnews({
    status: 'topnews2',
    totalResults: 38,
    articles: [
        {
...
export const DUMMY_TOPNEWS_3 = new Topnews({
    status: 'topnews3',
    totalResults: 38,
    articles: [
        {
